  ...
  <!-- content -->
            ...
            <div class="wrapper wrapper-content">
              ...
              <div class="ibox-content">
                  <div class="row">
                    ...
                    <div class="col-md-2 pull-right">
                      <a href="" data-toggle="modal" data-target="#modalTmbh2" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                    </div>
                  </div><br>
                  <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                        ...
                        <tr class="gradeX">
                            ...
                            <td>
                              <center>
                                <a class='btn btn-warning btn-xs' title='Edit Data' href='' data-toggle="modal" data-target="#modalEdit2" ><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Hapus Data' href='#'><span class='glyphicon glyphicon-trash'></span></a>
                              </center>
                            </td>
                        </tr>
            ...
            <div class="modal inmodal" id="modalEdit1" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content animated fadeInDown">
                        <div class="modal-header">
