                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Nama Ketua Prodi:</label>
                              <div class="col-lg-6"><input type="text" data-provide="typeahead" data-source='["item 1","item 2","item 3"]' class="form-control" value="Pak Kaprodi S.pd-1234567" required></div>
                            </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">No HP Ketua:</label>
                              <div class="col-lg-6"><input type="number" min="0" class="form-control" value="0851123262" required></div>
                            </div>
                            <div class="form-group">
                              <label class="col-lg-2 control-label">No Telepon Prodi:</label>
                                <div class="col-lg-6"><input type="number" min="0" class="form-control" value="021910191"></div>
                              </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Nama Operator Prodi:</label>
                              <div class="col-lg-6"><input type="text" data-provide="typeahead" data-source='["item 1","item 2","item 3"]' class="form-control" value="-"></div>
                            </div>
                            <div class="form-group">
