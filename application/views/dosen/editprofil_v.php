                ...
                <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label class="col-lg-2 control-label">NIP:</label>
                          <div class="col-lg-6"><input type="text" placeholder="123456789" class="form-control" disabled></div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label">Jabatan:</label>
                            <div class="col-lg-6"><input type="text" placeholder="Dosen Tetap" class="form-control" disabled></div>
                          </div>
                      <div class="form-group">
                        <label class="col-lg-2 control-label">Kelas Wali:</label>
                          <div class="col-lg-6"><input type="text" placeholder="IF-38-09" class="form-control" disabled></div>
                        </div><br ><br >
